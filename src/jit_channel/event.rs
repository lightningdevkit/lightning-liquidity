...
pub enum Event {
	...
	/// You should call [`lightning::ln::channelmanager::ChannelManager::fail_intercepted_htlc`].
	FailInterceptedHTLC {
		/// The identifier LDK uses to uniquely identify an intercepted HTLC.
		intercept_id: InterceptId,
	},
	/// You should call [`lightning::ln::channelmanager::ChannelManager::forward_intercepted_htlc`].
	ForwardInterceptedHTLC {
		/// The identifier LDK uses to uniquely identify an intercepted HTLC.
		intercept_id: InterceptId,
		/// The channel to forward the HTLC over.
		next_hop_channel_id: [u8; 32],
		/// The node that should receive the HTLC.
		next_node_id: PublicKey,
		/// How many msats the HTLC should be for.
